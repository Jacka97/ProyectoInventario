...
class consultaPeriferico{
    ...
    public static function insertarPeriferico($nombre, $ordenador_id, $marca,  $precio){
        $conexion = conexionBD::conectar();
        $sql = "INSERT INTO Perifericos (nombre, ordenador_id, marca_id, precio) VALUES ('$nombre', '$ordenador_id','$marca', '$precio')";
        $conexion->query($sql);
        return $conexion->insert_id;
        $conexion->close();
        
    }
    public static function actualizarPeriferico($id, $nombre, $ordenador_id, $marca_id,  $precio){
        $conexion = conexionBD::conectar();
        $sql = "UPDATE Perifericos SET nombre = '$nombre', ordenador_id = '$ordenador_id', marca_id = '$marca_id', precio = '$precio' WHERE id = '$id';";
        $conexion->query($sql);
