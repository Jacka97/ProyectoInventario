...
class consultaSoft{
    ...
    public static function getAllSoftwarePC(){
        ...
        $sql = "SELECT Software_PC.*, Software.nombre as softnombre, Ubicaciones.nombre as nombreUbicacion, Ordenadores.nombre as pcnombre from Software_PC 
            left join Software on Software.id = Software_PC.idSoftware 
            left join Ordenadores on Ordenadores.id = Software_PC.idPC
            left join Ubicaciones on Ordenadores.idUbicacion = Ubicaciones.id";
